...
suite("Dictionary", () => {
    ...
    test("Can check if an item exists", () => {
        ...
        assert.equal(dictionary.contains(new KeyValuePair<string,number>("b", 2)),true);
        assert.equal(dictionary.contains(new KeyValuePair<string, number>("d", 4)),false);
    });
    ...
    test("Can copy data to an array", () => {
        ...
        var array: KeyValuePair<string, number>[] = [];
    ...
    test("Can copy data to an array starting at a set index", () => {
        ...
        var array: KeyValuePair<string, number>[] = [new KeyValuePair("x", 100), new KeyValuePair("y", 200), new KeyValuePair("z", 300)];
