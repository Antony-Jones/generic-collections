...
suite("Dictionary", () => {
    ...
    test("Can check if an item exists", () => {
        ...
        dictionary.add("b", 2);
        dictionary.add("c", 3);
        assert.equal(dictionary.contains(new KeyValuePair("b", 2)), true);
        assert.equal(dictionary.contains(new KeyValuePair("d", 4)), false);
    });
    ...
    test("Can copy data to an array starting at a set index", () => {
        ...
        dictionary.add("b", 2);
        dictionary.add("c", 3);
        var array = [new KeyValuePair("x", 100), new KeyValuePair("y", 200), new KeyValuePair("z", 300)];
